...
/**
 * @extends {Presenter<CommentContainerView, FilmModel>}
 */
class CommentContainerPresenter extends Presenter {
  /**
   * @override
  ...
  createFilmCardState(item) {
    ...
    return {
      ...item,
      // TODO сделать параметры необязательными + дефолтные значения установить в utils
      // дефолтные  значения устанавливаем через констант
...
export default CommentContainerPresenter;
